        ...
        <div class="container-fluid item-detail-container">
            ...
            <div class="row detail-form-container">
                ...
                <form class="col">
                    ...
                    <textarea class="form-control input-field" name="" id="" cols="1" rows="6"></textarea> 
                    ...
                    {{-- submit button --}}
                    <input type="submit" value="Simpan" class="btn btn-primary mt-3 submit-button">
                </form>
            </div>
        </div>
    </body>
