        <?php 
            ...
            if(isset($_POST['edit_car'])) {
                ...
                // query for update
                $query_syntax = "UPDATE showroom_daffa_table nama_mobil='$nama_mobil', pemilik_mobil='$nama_pemilik', merk_mobil='$merk', tanggal_beli='$tanggal_beli', deskripsi='$deskripsi', status_pembayaran='$status_mobil'";
